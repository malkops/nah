...
5.3. [Практика. DevOps - Оркестрация группой Docker-контейнеров на примере Docker Compose](https://github.com/malkops/nah/blob/master/virtualization/homeworks/05-virt-03-docker.md)
